...
void loop() {
  ...
  bool aboveDelta = abs(xHigh - g_xHighPrev) >= g_changeTolerance 
                 || abs(xLow  - g_xHighPrev)  >= g_changeTolerance 
                 || abs(yHigh - g_xHighPrev) >= g_changeTolerance 
                 || abs(yLow  - g_xHighPrev)  >= g_changeTolerance; 
...
void setJoystickInitialization(bool cmdResponseEnabled) {
  ...
  g_xHighPrev = xHighNeutral = xHigh;
  g_xHighPrev = xLowNeutral = xLow;
  g_xHighPrev = yHighNeutral = yHigh;
  g_xHighPrev = yLowNeutral = yLow;
